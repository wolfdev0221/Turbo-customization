...
$(document).ready(function() {
  $('.gallery-wrap.product-height-set .product_gallery img').height($('.gallery-wrap.product-height-set .product_gallery img').width());
//   if ($(window).width() >= 798) 
//     $('.product__images.container_pp').height($('.product_right_top_container_p').height() + $('.product_right_bottom_container_p').height() + 72);
...
//       $('.product__images.container_pp').height($('.product_right_top_container_p').height() + $('.product_right_bottom_container_p').height() + 72);
  ...
  $('.order_sample').on('click', function() {
    $('.sample_modal_p').fadeIn();
    $('body').css({ 
      'overflow-y': 'hidden',
      'padding-right': '15px'
    });
  ...
  $('.order_trend').on('click', function() {
    $('.trend_modal_p').fadeIn();
    $('body').css({ 
      'overflow-y': 'hidden',
      'padding-right': '15px'
    });
  ...
  $('.close_trend').on('click', function() {
    $('.trend_modal_p').fadeOut();
    $('body').css({ 
      'overflow-y': 'auto',
      'padding-right': '0'
    });
  ...
  $('.product_calculator_p').on('click', function() {
    $('.calc_modal_p').fadeIn();
    $('body').css({ 
      'overflow-y': 'hidden',
      'padding-right': '15px'
  ...
  $('.close_calc').on('click', function() {
    $('#width_p').val('');
    $('#height_p').val('');
    $('.est_text_p').text('');
    $('.calc_modal_p').fadeOut();
    $('body').css({ 
      'overflow-y': 'auto',
      'padding-right': '0'
    });
  ...
  $('.calc_calc').on('click', function() {    
    var tmp1 = $('#width_p').val()*$('#height_p').val() / 6;
    var tmp2 = $('#width_p').val()*$('#height_p').val() / 7;
    var text = "You will need " + tmp2.toFixed(1) +'~' + tmp1.toFixed(1) +" litres of paint";
    console.log(text);
    $('.est_text_p').text(text);
  });
